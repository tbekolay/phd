...
??? Figure: NCC pipeline, like AuditoryBasedFeatureVectors.pdf
...
\begin{equation}
  \text{FAMILY} = \text{FAM} \bind \text{POS1} \oplus
    \text{SCHWA} \bind \text{POS2} \oplus
    \text{LEE} \bind \text{POS3}.
\end{equation}
...
\begin{equation}
  \text{FAM} \approx \text{FAMILY} \bind \text{POS1}^{-1}
\end{equation}
...
??? Figure: zoom in on sequencer also
