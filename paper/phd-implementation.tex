...
??? try to work in the temporal associative memory term in here,
or use one to clean up to a static syllable?
Yeah, that should be doable actually,
and hook it up to a working memory
so that the recognized syllable sticks around.
SO then you can just hook up the output
of the prod network to the recog network!
