...
\probbox{Once the intention to voice a syllable
  has been formed, the motor system must translate
  a static conceptual representation of that syllable
  ...
  a motor command trajectory from a static syllable representation?}
