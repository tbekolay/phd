...
% \fig{ncc}{0.8}{???}{???}
% ??? Figure: NCC pipeline, like abdulla.pdf
% or kumar.pdf
...
% \fig{ncc-network}{0.8}{???}{???}
% net diagram -- include the derivatives
...
as the synaptic filter model.\footnote{
  ...
  \citet{tripp2010} notes that this form of network
...
($\tau_s=0.1 \text{ s}$).\footnote{
  ...
  AMPA receptors \citep{jonas1993}5.}
...
neurotransmitter receptors.\footnote{
  ...
  \citet{tripp2010} notes that a derivative circuit
...
on average (see \citealt{pellegrino2007}).
