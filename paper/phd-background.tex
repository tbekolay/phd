...
\fig{an-overview}{0.8}{Overview of the human ear.}{
  ...
  and cuase the tympanic membrane to vibrate.
  These vibrations cause a tiny bone
  called the stapes to rapidly move
...
\fig{cochlea}{0.55}{Cochlea cross-section.}{
  ...
  Adapted from
  \url{https://commons.wikimedia.org/wiki/File:Organ_of_corti.svg}.}
...
\begin{figure}[ht!]
  ...
  \caption[Vowels defined in the IPA.]{Vowels defined in the
    ...
    is open or closed.
    The horizontal axis reflects wether the tongue
...
\fig{vt}{0.4}{Sagittal view of the human vocal tract.}{
...
\fig{production}{0.2}{Hierarchy of linguistic concepts in speech production.}{
  ...
  Words are composed of one or more syllabes,
...
\citep{browman1989,goldstein2006}.\footnote{
  ...
  However, we will use
  the terminology of vocal tract gestures
  in this thesis.}
...
Howver, there is evidence that children
