...
the integration of the two aspects of speech
cannot be easily interrogated through
psychological or linguistic means;
integration between the two depends
solely on how the brain
represents and transforms
auditory, acoustic and linguistic information.
At some point in the brain,
auditory information and
higher-level linguistic features
extracted from that auditory information
are transformed into representations
that drive the motor hierarchy
to produce speech;
...
and interact,
many experiments have give us clues
as to how the information is transformed,
and in what parts of the brain those
...
and the dorsal stream is involved in
object localization.
In the speech processing case,
the ventral stream
is involved in lexical processing
(the meaning behind incoming sounds),
and the dorsal stream
is involved in sensorimotor action mapping.

??? transformations: nature12935.pdf; good intro

??? neuron2010.pdf: central auditory representation!
...
??? sbs107.pdf : auditory-verbal hallucinations may be due to
faulty connectivity between wernicke / broca

??? Arcuate Fasciculus, connects wernicke's to broca's;
not present or very small in non-human primates.
??? first: historical perspective, nihms-128093.pdf

??? science-1998...pdf : prism shifting, like visual

??? STG stuff: nihmns231455.pdf, 1006.full.pdf

??? mirror neurons? Probably not, but what people call mirror
neurons probably corresponds to the actual transformation
happening here. nature2008.pdf
